...
//        $("#jsGrid-ModificacionDeStock").jsGrid({
//            width: "100%",
//            autoload: true,
//            filtering: true,
//            editing: true,
...
//                        dataType: "json",
//                        data: JSON.stringify({ 'depositoId': db.DepositoId, 'Filtros': parametros }),
...
//                { name: "Cantidad", type: "number", width: 100, autosearch: true, title: "Stock" },
//                { name: "PMR", type: "number", width: 100, autosearch: true }
//            ]
//        });
//    });
