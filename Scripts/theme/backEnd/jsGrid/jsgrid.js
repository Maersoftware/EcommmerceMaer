...
(function (window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        editItem: function (item) {
            var grid = this;
            var $row = grid.rowByItem(item);
            if ($row.length) {
                grid._editRow($row, grid);
        ...
        _editRow: function ($row, grid) {
            ...
            //Agregado por Eze y Nico para que al tocar enter updatee y al tocar escape corte la edicion 20200512
            $editRow.on("keydown", function (e) {
