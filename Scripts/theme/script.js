...
(function ($) {
    ...
    $('.list-layout-view').on('click', function (e) {
        ...
        $("div#contenedorArticulos").attr("selectedview", '.list-layout-view');
        ...
        $(".product-imgbox").removeClass('product-box-height2');
    ...
    $('.grid-layout-view').on('click', function (e) {
        ...
        $(".product-imgbox").removeClass('product-box-height3');
        $(".product-imgbox").removeClass('product-box-height2');
        $(".product-imgbox").addClass("product-box-height6");
        $("div#contenedorArticulos").attr("selectedview", '.grid-layout-view');
    ...
    $('.product-2-layout-view').on('click', function (e) {
        if ($('.product-wrapper-grid').hasClass("list-view")) { }
            ...
            $(".product-imgbox").removeClass('product-box-height3');
            $(".product-imgbox").removeClass('product-box-height2');
            $(".product-imgbox").addClass("product-box-height2");

        }
        $("div#contenedorArticulos").attr("selectedview", '.product-2-layout-view');
    });
    $('.product-3-layout-view').on('click', function (e) {
        if ($('.product-wrapper-grid').hasClass("list-view")) { }
            ...
            $(".product-imgbox").removeClass('product-box-height3');
            $(".product-imgbox").removeClass('product-box-height2');
            $(".product-imgbox").addClass("product-box-height3");
        }
        $("div#contenedorArticulos").attr("selectedview", '.product-3-layout-view');
    });
    $('.product-4-layout-view').on('click', function (e) {
        if ($('.product-wrapper-grid').hasClass("list-view")) { }
            ...
            $(".product-imgbox").removeClass('product-box-height3');
            $(".product-imgbox").removeClass('product-box-height2');
            $(".product-imgbox").addClass("product-box-height4");
        }
        $("div#contenedorArticulos").attr("selectedview", '.product-4-layout-view');
    });
    $('.product-6-layout-view').on('click', function (e) {
        ...
        $("div#contenedorArticulos").attr("selectedview", '.product-6-layout-view');
    });
    ...
    /*=====================
     10. Product page Quantity Counter
     ==========================*/
    //COMENTO PORQUE SINO ME SUMA DOS VECES EL ADD TO CART DESDE GALERIA
 ...
 // dark layout //
    ...
    /*$('button.add-button').on('click', function () {
        ...
        var $qty = $(this).siblings().first().children().children(".qty-input");
        $qty.val('1');
    });
    ...
    $('.qty-input').change(function () {
        Galeria.actualizarCantidad(this);
    });

    $('.qty-input').keyup(delay(function (e) {
        Galeria.actualizarOnKeyUp(this);        
    }, 500));*/

    // RUBY: Comenté todo esto porque lo puse más lindo en Galeria.js
